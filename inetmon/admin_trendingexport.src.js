...
var Chart = Highcharts.Chart,
	...
	extend(defaultOptions.lang, {
		...
		infoButtonTitle: 'Information about the chart',
		AllDayButtonTitle: 'Complete Trending',
		MondayButtonTitle: 'Monday Trending',
		TuesdayButtonTitle: 'Tuesday Trending',
		WednesdayButtonTitle: 'Wednesday Trending',
		ThursdayButtonTitle: 'Thursday Trending',
		FridayButtonTitle: 'Friday Trending',
		SaturdayButtonTitle: 'Saturday Trending',
		SundayButtonTitle: 'Sunday Trending',
		ThresholdButtonTitle: 'SetThreshold'
	});
...
document.getElementById('Tue').click();
		...
		WednesdayButton: {
			...
			hoverSymbolFill: '#779ABF',
			_id: 'WednesdayButton',
			_titleKey: 'WednesdayButtonTitle',
			onclick: function () {
document.getElementById('Wed').click();
			}
		},
		ThursdayButton: {
			//enabled: true,
			...
			hoverSymbolFill: '#779ABF',
			_id: 'ThursdayButton',
			_titleKey: 'ThursdayButtonTitle',
			onclick: function () {
document.getElementById('Thu').click();
			}
		},
		FridayButton: {
			//enabled: true,
			...
			hoverSymbolFill: '#779ABF',
			_id: 'FridayButton',
			_titleKey: 'FridayButtonTitle',
			onclick: function () {
document.getElementById('Fri').click();
			}
		},
		SaturdayButton: {
			//enabled: true,
...
document.getElementById('Sun').click();
		...
		ThresholdButton: {
			...
			hoverSymbolFill: '#779ABF',
			_id: 'ThresholdButton',
			_titleKey: 'ThresholdButtonTitle',
			onclick: function () {
