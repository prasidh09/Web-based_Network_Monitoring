...
var Chart = Highcharts.Chart,
	...
	extend(defaultOptions.lang, {
		...
		printButton1Title: 'Information about the chart',
		mapButtonTitle: 'Activity Distribution'
	});
...
defaultOptions.exporting = {
	...
	buttons: {
		...
		mapButton: {
			...
			hoverSymbolFill: '#779ABF',
			_id: 'printButton1',
			_titleKey: 'mapButtonTitle',
			onclick: function () {
document.getElementById('vectormap').click();
			}
		},
		printButton1: {
			//enabled: true,
